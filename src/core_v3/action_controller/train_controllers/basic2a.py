...
from ..action_router import Router2Action

from ...actions import BadAction, VoidAction, TradeAction


class BasicTrainController2A(Router2Action):
    """Обработчик действий для обучения с 4 действиями"""

    def __init__(self, alias, market_fee=0, wait_scale=0, open_scale=0, hold_scale=0, close_scale=0, last_points_mean=0):
