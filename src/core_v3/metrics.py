"""
Модуль реализует класс для сбора метрик из core_v1.

"""
import logging

from .actions import BadAction, TradeAction, VoidAction
...
class MetricCollector:
    ...
    BASIC_METRICS = ["Trades", "TotalReward", "Balance", "Penalties", "Rewards",
                     "PosTrades", "NegTrades", "StepsOpened", "StepsClosed"]
