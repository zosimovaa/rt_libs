...
from core_v1 import context
from core_v1 import action_controller
from core_v1 import observation_builder
from .observation_builder import features
from .observation_builder import inputs


class ConstructorGen2:
    """Конструктор core_v1 из конфига"""
