...
class TrainPlot2:
    PLOTS = [
        {"name": "Balances", "data": [("Train", "Balance"), ("Test", "Balance")]},
        {"name": "Penalties", "data": [("Train", "Penalties"), ("Test", "Penalties")]},
        # {"name": "Trade count", "data": [("Train", "PosTrades"), ("Train", "NegTrades")]}
    ]
    ...
    def init_plot(self, width=1000, height=700):
        ...
        for row_id in range(rows):
            ...
            for line in plot["data"]:
                name = " ".join(line)
                fig.add_scatter(row=row, col=1, name=name)
