...
class TrainPlot3:
    ...
    def update_plot(self, history):
        self.fig.data[0].x, self.fig.data[0].y = self.get_data(history, "train", "Balance")
        self.fig.data[1].x, self.fig.data[1].y = self.get_data(history, "test", "Balance")

        self.fig.data[2].x, self.fig.data[2].y = self.get_data(history, "train", "Penalties")
        self.fig.data[3].x, self.fig.data[3].y = self.get_data(history, "test", "Penalties")

        self.fig.data[4].x, self.fig.data[4].y = self.get_data(history, "train", "PosTrades")
        self.fig.data[5].x, self.fig.data[5].y = self.get_data(history, "train", "NegTrades")

        steps_0_x, steps_0_y = self.get_data(history, "train", "StepsClosed")
        steps_1_x, steps_1_y = self.get_data(history, "train", "StepsOpened")
