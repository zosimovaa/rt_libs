...
from src.core.action_controller import ActionControllerBasic, ActionControllerBasicOpposite
...
class TickerBasicTestCase(unittest.TestCase):
    ...
    def test_closed(self):
        ...
        ticker = ActionControllerBasic(self.context, penalty=self.penalty, reward=self.reward)
...
class TickerBasicOppositeTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def test_closed(self):
        ...
        # ==== Step 1 - подготовка тикера ====
        ticker = ActionControllerBasicOpposite(self.context, penalty=self.penalty, reward=self.reward)
