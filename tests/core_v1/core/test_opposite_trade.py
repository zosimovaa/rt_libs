...
from src.core_v1.tickers import TickerOppositeTradesReward
from src.core_v1.observation_builder.features import TradeStateFeature, ProfitFeature, OppositeProfitFeature
from src.core_v1.observation_builder import ObservationBuilder2Dim

from src.core_v1.facade import RTCore
...
class TickerBasicTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.ticker.last_points_mean = 2
